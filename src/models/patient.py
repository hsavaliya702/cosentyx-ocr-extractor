...
class PatientField(BaseModel):
    ...
    source: str = Field(
        default="form", description="Source of the field: 'form' or 'payload'"
    )
...
class PatientInfo(BaseModel):
    ...
    dob: PatientField = Field(
        default_factory=PatientField, description="Date of birth (MM/DD/YYYY)"
    )
    gender: PatientField = Field(
        default_factory=PatientField, description="Gender (M/F/Other)"
    )
