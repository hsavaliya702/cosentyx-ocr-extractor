...
from src.utils.formatters import format_date, format_phone, format_npi, format_state, format_zip
...
class FieldValidators:
    ...
    def validate_phone(phone_str: str) -> Tuple[bool, str, str]:
        ...
        if not formatted:
            return False, phone_str, f"Invalid phone format (must be 10 digits): {phone_str}"
    ...
    def validate_zip(zip_str: str) -> Tuple[bool, str, str]:
        ...
        if not formatted:
            return False, zip_str, f"Invalid ZIP code (must be 5 or 9 digits): {zip_str}"
